...
const PDFEditor = ({
  ...
  const handleExport = async () => {
    if (!signatures.length)
      return toast.error("No signatures placed to export");
    ...
    <div className="p-4 space-y-4 ">
      <div className="sticky top-0 z-30 bg-white shadow flex flex-wrap gap-3 p-3 rounded-md border mb-4 justify-between">
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="px-3 py-1.5 bg-sky-600 text-white text-sm rounded hover:bg-sky-700 flex items-center gap-2"
          >
            <FaPenFancy /> Draw
          </button>
          ...
          <button
            ...
            className="px-3 py-1.5 bg-indigo-600 text-white text-sm rounded hover:bg-indigo-700 flex items-center gap-2"
          >
            <FaFont /> Type
          </button>
          ...
          {!isPublic && (
            <button
              ...
              className="px-3 py-1.5 bg-purple-600 text-white text-sm rounded hover:bg-purple-700 flex items-center gap-2"
            >
              <FaUniversity /> Saved
            </button>
          )}
          ...
          {!isPublic && (
            <button
              onClick={goBack}
              className="px-3 py-1.5 bg-gray-300 text-sm rounded hover:bg-gray-400 flex items-center gap-2 text-gray-800"
            >
              <FaArrowLeft /> Back
            </button>
          )}
      ...
      >
        <Worker workerUrl="https://unpkg.com/pdfjs-dist@3.4.120/build/pdf.worker.min.js">
          <Viewer
            fileUrl={`${SERVER_BASE_URL}/${pdfDoc.filepath}`}
          ...
          <div className="bg-white p-6 rounded-lg shadow-xl w-[420px] space-y-4">
            ...
            <div className="flex justify-between">
              <button
                ...
                className="px-4 py-2 bg-gray-200 rounded hover:bg-gray-300 text-gray-800 flex items-center gap-2"
              >
                <FaTimes /> Clear
              </button>
              <button
