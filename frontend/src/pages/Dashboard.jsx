// Use same imports as your original
...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen p-4 bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="flex justify-between items-center mb-6 flex-wrap gap-4">
        {!selectedDoc && (
          <h2 className="text-2xl font-bold text-blue-800">
            Click Below To Upload your PDF 👇👇👇
          </h2>
        )}
        {!selectedDoc && (
      ...
      <h2 className="text-4xl font-extrabold text-blue-800 w-full my-20 text-center">
        Your Uploaded PDFs
      </h2>
      {!selectedDoc ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredDocs.map((doc) => (
            <div
              key={doc._id}
              className="bg-white rounded-lg shadow-lg p-4 transform transition-all hover:scale-[1.02] hover:shadow-xl relative border border-blue-100"
            ...
            >
              ...
              <div className="absolute top-2 right-2 flex gap-2 z-10">
                ...
                <button
                  ...
                  className="text-xs px-2 py-1 bg-blue-700 text-white rounded hover:bg-blue-800 flex items-center gap-1"
                >
